function userInput(event){
  ...
  if (questionJava && questionJava2 === "Yes" && questionCSharp === "No" && questionPython === "Curly braces" && questionRuby === "Kyogre") {
    ...
    result = "Fullstack? Try being more specific, there's many different languages you can learn with curly braces. Team Kyogre!"
    ...
    result = "Javascript AND C#! Check out Epicodus and Pokemon Sapphire while you learn!"
  } else if (questionJava && questionJava2 && questionCSharp === "Yes" && questionPython === "Curly braces" && questionRuby === "Groudon") {
    result = "Javascript AND C#! Check out Epicodus and Pokemon Ruby while you learn!"
    ...
    result = "Javascript AND C#! Depending on what you master, it could be worth it to check out Python in the future."
  ...
  } else if (questionJava === "Yes" && questionJava2 && questionCSharp === "No" && questionPython === "Indentation" && questionRuby === "Groudon") {
    result = "Javathon! Just kidding. You should learn Javascript!"
  }
